...
namespace nor_utils
{
	...
	// -----------------------------------------------------------------------
	/**
	 * Normalize the length of a vector containing real-numbers
	 * \param str The vector of elements
	 * \date 17/10/2011
	 */
	
	template < typename T >
	void normalizeLengthOfVector( vector<T>& vec )
	{
		T sum = 0.0;
	...
	template < typename T >
	T innnerProduct( vector<T>& vec1, vector<T>& vec2 )
	{							
		T sum = 0.0;
