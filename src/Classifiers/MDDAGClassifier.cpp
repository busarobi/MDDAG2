...
namespace MultiBoost {
	...
	void MDDAGClassifier::savePosteriors(const string& dataFileName, const string& shypFileName, 
	...
	float MDDAGClassifier::getOverallError( InputData* pData, const vector<ExampleResults*>& results, 
												int atLeastRank )
	{
		const int numExamples = pData->getNumExamples();
		int numErrors = 0;
	...
	void MDDAGClassifier::getClassError( InputData* pData, const vector<ExampleResults*>& results, 
