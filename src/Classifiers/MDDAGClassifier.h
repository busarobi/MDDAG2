...
#ifndef __MDDAG_CLASSIFIER_H
#define __MDDAG_CLASSIFIER_H
...
namespace MultiBoost {
	...
	public:
		 ...
		 * \date 16/11/2005
		 */
		MDDAGClassifier(const nor_utils::Args& args, int verbose = 1);
	...
	private:
		 ...
		 * \date 6/12/2005
		 */
		MDDAGClassifier& operator=( const MDDAGClassifier& ) {return *this;}
